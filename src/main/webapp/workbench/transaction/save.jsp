        ...
        $(function () {
            ...
            $("#create-stage").change(function () {
                ...
                /*
                    ...
                    阶段有了：stage
                    阶段和可能性之间的对应关系：pMap，但是pMap是java语言中的键值对关系（map）

                    首先将map转换成js中的键值对关系（json）
                 */
                /*
                    我们现在不能以json.key的形式来取value
                    因为今天的stage是一个可变的变量
                    如果是这样的key，就不能使用传统的json.key的形式来取
                    应该用：
                            json[key]
                 */
...
<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            ...
            <input type="hidden" name="activityId" id="00bd15aa9ea24631b618fcbc14463168"/>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            ...
            <input type="hidden" name="contactsId" id="01617b282a5f469c9087896d5083a4d4"/>
        </div>
    </div>
