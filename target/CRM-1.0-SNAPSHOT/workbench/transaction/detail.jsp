...
<%@ page import="com.bjcomeon.crm.settings.domain.DicValue" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="java.awt.*" %>
<%@ page import="com.bjcomeon.crm.workbench.domain.Tran" %>
    ...
    <script type="text/javascript">
        ...
        function changeStage(stage, i) {
            $.ajax({
                ...
                data:{
                    "id":"${t.id}",
                    "stage": stage,
                    "money":"${t.money}",    //生成交易历史时要用到的参数
                    "expectedDate":"${t.expectedDate}"    //生成交易历史时要用到的参数
                },
                type:"post",
                dataType:"json",
                success:function (data){
        ...
        function changeIcon(stage,index1){
            ...
            if (currentPossibility == "0"){
                ...
                //如果当前阶段的可能性不为0    前7个可能为绿圈，绿色标记，黑圈，后两个一定为黑叉
            }else {
                //遍历前7个
                for (var i = 0; i < point; i++) {
                    //如果是当前阶段
...
<div style="position: relative; left: 40px; top: -50px;">
    ...
    <%
        ...
        //判断当前阶段
        //如果当前阶段可能性为0 【前七个一定为黑圈，后边两个一个红×一个黑×】
    ...
    <%
            ...
            //如果当前阶段可能性不为0 【前7个有可能为绿圈，绿色标记，黑圈，后两个一定为黑×】
        } else {
            //准备当前阶段的下标
            int index = 0;
            for (int i = 0; i < dvList.size(); i++) {
    ...
    <%
                    ...
                    //如果遍历出来的阶段的可能性不为0，说明是前7个阶段（绿圈，黑圈，绿色标记）
                } else {
                    //如果是当前阶段
                    if (i == index) {
                        //绿色标记---------------------------------------
