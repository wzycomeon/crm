    ...
    <script type="text/javascript">
        ...
        $(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.success) {
                            ...
                            html += '&nbsp;&nbsp;&nbsp;&nbsp;';
                            html += '<a class="myHref" href="javascript:void(0);" onclick="deleteRemark(\'' + data.ar.id + '\')"><span class="glyphicon glyphicon-trash" style="font-size: 20px; color: #FF0000;"></span></a>';
                            html += '</div>';
                            html += '</div>';
                            html += '</div>';
            ...
            $("#updateRemarkBtn").click(function () {
                ...
                //回调函数中 success:function (data){}也需要使用 id ，故写在ajax外
                var id = $("#remarkId").val();
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.success) {
                            //修改成功
                            //更新div中相应的信息，需要更新的内容：noteContent、editBy、editTime
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, n) {
                        ...
                        html += '&nbsp;&nbsp;&nbsp;&nbsp;';
                        html += '<a class="myHref" href="javascript:void(0);" onclick="deleteRemark(\'' + n.id + '\')"><span class="glyphicon glyphicon-trash" style="font-size: 20px; color: #FF0000;"></span></a>';
                        html += '</div>';
                        html += '</div>';
                        html += '</div>';
                    })
        ...
        function deleteRemark(id) {
            if (confirm("确定要清除所选记录吗？")) {
                $.ajax({
                    url: "workbench/activity/deleteRemart.do",
                    data: {
                        "id": id
                    },
                    type: "post",
                    ...
                    success: function (data) {
                        ...
                        if (data.success) {
                            //删除备注成功后
                            //刷新备注列表,这种做法不行，记录使用的before方法，每次删除之后会保留原有数据
                            //showRemarkList();
                            //找到需要删除记录的div，将div删除
                            $("#" + id).remove();
